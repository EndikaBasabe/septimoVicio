...
<div class="container-fluid text-center"> 
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
		...
		Título Original: <%= pelicula.getTituloOriginal() %><br>
		Año: <%= pelicula.getAnioPelicula() %> <br>
		Duración: <%= pelicula.getDuracion() %> <br>
		País: <%= pelicula.getPais() %> <br>
		Director: <%= pelicula.getDirector() %> <br>
		Guión: <%= pelicula.getGuion() %> <br>
		Fotografía: <%= pelicula.getFotografia() %> <br> 
		...
		Críticas: <%= pelicula.getCriticas() %> <br>
    </div>
    <div class="col-sm-2 sidenav">
      <div class="well">
        <p>ADS</p>
